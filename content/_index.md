...
I am a final year computer science student at the Chinese University of Hong Kong interested in the systems side of computer science (e.g. distributed systems, cloud, database). I developed software projects ranging from web apps, mobile apps, to games and chat bots. Currently working on a web-based multiplayer monopoly game (using Go and Godot) as my final year project.

I also enjoy drawing, writing, reading novels and listening to music in my free time.
